  ...
  <div class="general__section">
    ...
    <section id="cotizador-8">
      <div class="column__left">
        <h2>¡Felicidades!</h2>
        <p>
          Cada vez estás más cerca de iniciar con tu gran regalo corporativo y otorgar una experiencia única a tus clientes, colaboradores y socios.
        </p>
        ...
        <ul>
          ...
          <li>Ayuda en la generación de nuevas ideas.</li>
      ...
      <div class="column__right">
        ...
        <div class="advice__container">
          ...
          <ul>
            ...
            <li>
              56% de los compradores indican que el dar un regalo personalizado ayudaría en el posicionamiento e imagen de su marca.
            </li>
            <li>
