      ...
      <div id="registro">
        <div class="formulario">
          <form id="form">
            ...
            <input type="text" name="nombre" id="nombre" placeholder="Ingresa tu nombre*" v-model.trim="formData.name"
              required />
            <label for="correo" class="form-label">
              <i class="fas fa-envelope"></i> Correo:</label>
            <input v-model.trim="formData.email" type="email" name="correo" id="correo"
              placeholder="Correo Corporativo*" required />

            <label for="telefono" class="form-label">
              <i class="fab fa-whatsapp"></i> Teléfono:</label>
            <input v-model.trim="formData.telefono" type="text" name="telefono" id="telefono"
              placeholder="Ingresa tu teléfono de contacto" />
            <label for="categoria">¿Qué te interesa?</label>
            <select class="select" name="categoria" id="categoria" v-model="selected">
...
// tiene un e-mail corporativo valido 
      ...
      // o de lo contrario 
          ...
          //si no cumple con el formato se muestra mensaje
        ...
        // de lo contrario continua
          ...
          this.showMensaje = true;
          // si el numero ingresado cumple el formato
